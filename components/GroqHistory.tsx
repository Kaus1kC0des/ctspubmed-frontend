...
const GroqHistory: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-slate-800">Groq Cached Searches</h1>
      ...
      <div className="mt-4 grid gap-2">
        ...
        {items.length === 0 && !loading && (
          <p className="text-slate-600">No Groq cached searches found.</p>
        )}
      </div>
    </div>
  );
